...
int main(int argc, char **argv) 
{
	...
	pthread_create(&tid[0], NULL, sort_thread, (void *)&first_half);
	/* TODO: 2nd Thread / Sort second half of data */
	pthread_create(&tid[1], NULL, sort_thread, (void *)&second_half);
  ...
  /* 3.MERGE */
	...
	pthread_create(&tid[3], NULL, merge_thread, (void *)&merge_range);
